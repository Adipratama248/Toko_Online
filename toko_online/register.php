            ...
            <div class="card-body p-4">
              ...
              <form action="proses_tambah_petugas.php" method="POST">
                ...
                <div data-mdb-input-init class="form-outline mb-4">
                  <input type="text" required=""  name="nama_petugas" class="form-control form-control-lg" placeholder="Nama" />
                </div>

                <div class="row">
                <div class="col-md-6 mb-4">
                <div data-mdb-input-init class="form-outline mb-4">
                  <input type="text" required=""  name="username_petugas" class="form-control form-control-lg" placeholder="Username" />
                </div>
                </div>
                ...
                <div data-mdb-input-init class="form-outline mb-4">
                <input type="password" required=""  name="password_petugas" class="form-control form-control-lg" placeholder="password" />
                </div>
